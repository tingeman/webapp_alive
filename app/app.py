...
app = dash.Dash(__name__, external_stylesheets=[dbc.themes.BOOTSTRAP, dbc_css], 
                server=server,
                requests_pathname_prefix='/app/alive/',
                routes_pathname_prefix='/app/alive/')
...
app.layout = html.Div(children=[
    html.Div([
        dbc.Row(dbc.Col(html.H1('Alive messages from RPi control boxes... (This is the production server version)'), width="auto")),
